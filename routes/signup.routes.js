...
router.post("/signup", async (req, res, next) => {
    ...
    if (regexPatter.test(req.body.password) === false) {
        res.render("crear-usuario/signup.hbs", {
            errorMessage: "La contraseña debe ser mas fuerte, debe contener al menos 8 caracteres, una mayuscula y una minuscula"
        });
        return;
    }
    ...
    console.log(hashedPassword);
        ...
        const response = await User.create({ 
         ...
         res.redirect("/crear-usuario/signup");
    } catch (error) {
...
router.post("/login", async (req, res, next) => {
    ...
    try {
        ...
        console.log(validPassword);
                ...
                res.redirect("/crear-usuario/login");
